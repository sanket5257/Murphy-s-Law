    ...
    <div className="min-h-screen pt-32 bg-black text-white">
      ...
      <div className="py-16 px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-migra mb-4 text-white">Terms of Service</h1>
      ...
      <div className="max-w-4xl mx-auto px-8 pb-16">
        <div className="prose prose-lg max-w-none prose-invert">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">1. Acceptance of Terms</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">2. Description of Service</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">3. User Accounts and Registration</h2>
            
            <h3 className="text-xl font-migra mb-4 text-white">3.1 Account Creation</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-migra mb-4 text-white">3.2 Professional Verification</h3>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">4. Acceptable Use Policy</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">5. Intellectual Property Rights</h2>
            
            <h3 className="text-xl font-migra mb-4 text-white">5.1 Our Intellectual Property</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
            ...
            <h3 className="text-xl font-migra mb-4 text-white">5.2 User Content</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">6. Privacy and Data Protection</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">7. Professional Responsibility and Legal Advice Disclaimer</h2>
            
            <h3 className="text-xl font-migra mb-4 text-white">7.1 No Attorney-Client Relationship</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
            ...
            <h3 className="text-xl font-migra mb-4 text-white">7.2 Professional Judgment Required</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
            ...
            <h3 className="text-xl font-migra mb-4 text-white">7.3 Accuracy and Reliability</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
          ...
          {/* Payment Terms */}
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">8. Payment Terms</h2>
            
            <h3 className="text-xl font-migra mb-4 text-white">8.1 Subscription Fees</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-migra mb-4 text-white">8.2 Refund Policy</h3>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">9. Service Availability and Modifications</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">10. Limitation of Liability</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
          ...
          {/* Indemnification */}
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">11. Indemnification</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
          ...
          {/* Termination */}
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">12. Termination</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">13. Governing Law and Dispute Resolution</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
          ...
          {/* Changes to Terms */}
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">14. Changes to These Terms</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
          ...
          {/* Contact Information */}
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">15. Contact Information</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-4">
            ...
            <div className="bg-white/5 p-6 rounded-lg border border-white/10">
              ...
              <p className="font-montreal text-white/70 leading-relaxed mb-2">
                Email: legal@murphyslawai.com
              </p>
              <p className="font-montreal text-white/70 leading-relaxed mb-2">
                Support: support@murphyslawai.com
              </p>
              <p className="font-montreal text-white/70 leading-relaxed">
          ...
          {/* Severability */}
          <section className="mb-12">
            <h2 className="text-2xl font-migra mb-6 text-white">16. Severability</h2>
            <p className="font-montreal text-white/70 leading-relaxed mb-6">
