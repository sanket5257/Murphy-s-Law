...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative bg-black text-white pb-8 px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32 overflow-hidden">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="font-montreal text-white/80">076 787 7637</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
